...
Config.CarGarageName = "Garage de véhicule"
...
Config.HeliGarageName = "Garage d'hélicoptères"
...
Config.BoatGarageName = "Garage de Bateau"
...
Config.PoliceCarMarker = 38 												-- marker type
Config.PoliceCarMarkerColor = {r = 50, g = 50, b = 204} 			-- rgba color of the marker
Config.PoliceCarMarkerScale = {x = 1.5, y = 1.5, z = 0.5} 				-- the scale for the marker on the x, y and z axis
...
-- Menu Labels & Titles:
Config.LabelStoreVeh = "Rentrer votre Véhicule"
...
Config.VehicleParked = "Tu a bien rangé ton véhicule!"
