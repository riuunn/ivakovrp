Locales['fr'] = {
  ...
  ['respawn_fine'] = 'vous avez payé ~r~$%s~s~ pour réapparaître.',
  ['distress_send'] = 'appuyez sur ~b~[G]~s~ pour envoyez un signal de détresse',
  ['distress_sent'] = 'un signal de détresse a été envoyé à toutes les unités',
  ['distress_message'] = 'aide médicale nécessaire : l\'individu est inconscient!',
  -- Revive
