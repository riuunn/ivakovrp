locales['de'] = {
    ...
    ["explosion_in_zone"] = "Es war eine ~r~EXPLOSION~s~ in ~y~%s~s~",
    ...
    ['someone_tried_to_sell_drugs'] = "Jemand hat versucht ~r~Drogen~s~ bei ~y~%s~s~ zu verkaufen",
    ...
    ['logs:soldToPusher:description'] = "Verkauft **%s** für **$%s** an Schieber ID **%d**",
}