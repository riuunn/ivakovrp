...
function editLaboratory(laboratoryId) {
	...
	$("#laboratory-allowed-crafting-recipes").text( Object.keys(laboratoryData.allowedRecipes).map(recipeId => craftingRecipes[recipeId] ? craftingRecipes[recipeId].name : null).join(", ") );
	$("#laboratory-allowed-crafting-recipes").data("recipes", laboratoryData.allowedRecipes);
...
function loadSettings(fullConfig) {
	...
	$("#boat-selling-account").val(fullConfig.planeSellingAccount);
	...
	$("#enable-missing-inventory-events-compatibility").prop("checked", fullConfig.enableMissingInventoryEventsCompatibility);
...
$("#settings").submit(function(event) {
	...
	let serverSettings = {
		...
		enableMissingInventoryEventsCompatibility: $("#enable-missing-inventory-events-compatibility").prop("checked"),
