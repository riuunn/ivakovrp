locales['el'] = {
    ...
    ['actions:license:give_remove'] = "<span style='color:green'>Δώσε</span>/<span style='color:red'>Αφαίρεση</span> άδειες",
    ...
    ["wardrobe:delete"] = "%s - <span style='color:red'>Διαγραφεί</span>",
    ...
    ["boss:wash_money"] = "<span style='color:red'>Πλύνετε χρήματα</span>",
    ...
    ["boss:fire"] = "<span style='color:red'>Απόλυση εργαζομένου</span>",
