locales['bh'] = {
    ...
    ['actions:license:give_remove'] = "<span style='color:green'>Daj</span>/<span style='color:red'>Oduzmi</span> dozvole",
    ...
    ["wardrobe:delete"] = "%s - <span style='color:red'>Obrisi</span>",
    ...
    ["boss:wash_money"] = "<span style='color:red'>Operi novac</span>",
    ...
    ["boss:fire"] = "<span style='color:red'>Otpusti</span>",
