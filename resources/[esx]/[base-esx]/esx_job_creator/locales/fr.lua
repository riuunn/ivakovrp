locales['fr'] = {
    ...
    ["billing_reason"] = "Raison de facturation",
    ["billing_amount"] = "Montant de facturation",
    ["no_players_nearby"] = "Aucun joueur à proximité",
    ["no_vehicles_nearby"] = "Aucun véhicule à proximité",
    ["invoice_sent"] = "Vous avez envoyé une facture d'une valeur de ~g~$%s~s~ ",
    ...
    ['actions_menu'] = "Menu Actions",
    ['actions_billing'] = "Facturation",
    ['actions_search'] = "Rechercher",
    ['actions_put_handcuffs'] = "Les menottes",
    ['actions_start_dragging'] = "Faites glisser",
    ['actions_put_in_car'] = "Mettre en voiture",
    ['actions_take_from_car'] = "Prendre de la voiture",
    ['actions_menu_search'] = "Rechercher un joueur",
    ['actions_lockpick_car'] = "Lockpick voiture",
    ...
    ['actions:no_vehicles_close'] = "Aucun véhicule proche",
    ['actions:impound_vehicle'] = "Véhicule en fourrière",
    ...
    ['actions:checkVehicleOwner:car_not_found'] = "Aucun véhicule proche",
    ['actions:no_player_found'] = "Personne proche",
    ...
    ['actions:licenses'] = "Licences",
    ['actions:no_license_found'] = "Aucune licence trouvée",
    ['actions:check_licenses'] = "Vérifier les licences",
    ['actions:driving_license'] = "Permis de conduire",
    ['actions:weapon_license'] = "Licence d'arme",
    ...
    ['actions:you_need_medikit'] = "Vous avez besoin d'un ~r~kit medical~s~",
    ...
    -- [[ Boss Stuff ]]
    ["open_boss"] = "Appuyez sur ~INPUT_CONTEXT~ pour ouvrir le menu du boss",
    ["not_boss"] = "Vous n'êtes pas le patron",
    ["boss_menu"] = "Menu du patron",
    ["boss:society_money"] = "<span style='color:green'>Argent de la société : $%s</span>",
    ...
    ["boss:grades"] = "<span style='color:blue'>Gérer les salaires des notes</span>",
    ...
    ["boss:grade_salary_updated"] = "~y~Grade Salaire~s~ ~g~updated~s~",
    ...
    ["boss:change_grade"] = "<span style='color:blue'>Changer de note</span>",
    ...
    ["boss:changed_grade_successfully"] = "Changement de note avec succès",
    ["boss:your_grade_changed_to"] = "Votre note est passée à ~b~%s~s~",
    ...
    ['are_you_sure'] = "Êtes-vous sûr d'acheter %s pour $%s ?",
    ...
    ['dont_have_ingredients'] = "Vous n'avez pas tous les ~r~requis~s~ éléments",
    ...
    ['you_stopped'] = "Vous vous arrêterez à la fin de la fabrication",
    ...
    ['armory'] = "armurerie",
    ['armory_take'] = "Armory - Prendre",
    ['armory_deposit'] = "Armory - Dépôt",
    ['take_weapon'] = "Prenez l'arme",
    ['deposit_weapon'] = "Dépôt d'arme",
    ...
    -- [[ Job outfit stuff ]]
    ['open_job_outfit'] = "Appuyez sur ~INPUT_CONTEXT~ pour ouvrir les tenues du job",
    ...
    ['nothing_can_be_sold_yet'] = "Rien ne peut encore être vendu ici",
    ['market:how_many_to_sell'] = "Combien voulez-vous vendre ?",
    ...
    -- [[ Duty Stuff]]
    ['go_on_duty'] = "Appuyez sur ~INPUT_CONTEXT~ pour aller ~g~en service~s~",
    ['go_off_duty'] = "Appuyez sur ~INPUT_CONTEXT~ pour aller ~r~hors service~s~",
    ...
    ['log_deposited_money'] = "Argent déposé",
    ['log_deposited_money_description'] = "Déposé $**%d** dans la société '**%s**'",

    ['log_withdrew_money'] = "Retiré de l'argent",
    ...
    ['log_fired_employee'] = "Employé licencié",
    ['log_fired_employee_description'] = "Joueur viré avec identifiant **%s**",

    ['log_recruited_employee'] = "Employé recruté",
    ['log_recruited_employee_description'] = "Recruté **%s** dont l'identifiant est **%s**",

    ['log_changed_grade_employee'] = "Changement de grade en employé",
    ['log_changed_grade_employee_description'] = "Changement de grade en employé **%s** en **%d**",
    ...
    ['log_deposited_safe'] = "Dépôt en coffre-fort",
    ...
    ['log_removed_component'] = "Composant supprimé",
    ['log_removed_component_description'] = "Retiré **%s** de **%s** de l'ID de marqueur **%d**",

    ['log_bought_component'] = "Composant acheté",
