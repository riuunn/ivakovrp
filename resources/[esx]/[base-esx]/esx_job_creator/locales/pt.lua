locales['pt'] = {
    ...
    ['actions:license:give_remove'] = "<span style='color:green'>Dar</span>/<span style='color:red'>Remover</span> licenses",
    ...
    ["wardrobe:delete"] = "%s - <span style='color:red'>Apagar</span>",
    ...
    ["boss:wash_money"] = "<span style='color:red'>Lavar dinheiro</span>",
    ...
    ["boss:fire"] = "<span style='color:red'>Despedir</span>",
